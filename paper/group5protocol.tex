...
\section{DFA}
\begin{tikzpicture}[->,>=stealth',shorten >=1pt,auto,bend angle=75,inner sep=0, every state/.style={draw=blue!50,very thick,fill=blue!20, font=\footnotesize}]
